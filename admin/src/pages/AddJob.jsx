...
export default function AddJob() {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      // Create a new job object with all required fields for dashboard display
      const newJob = {
          ...
          <div className="mx-auto max-w-4xl">
            ...
            {submitSuccess && (
              <div className="mb-6 p-4 bg-green-100 text-green-800 rounded-lg">
                Job published successfully! Redirecting to dashboard...
              </div>
            )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <button
                    ...
                    className={`rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
                  >
